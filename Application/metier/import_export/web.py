class Web():
    ...
    def __init__(self, id_dep : str, date = "latest" , zonage1 = "departements", id_zone = None, zonage2 = "communes" ):
        """lien de l'adresse d'import d'un fichier json à partir du web
        Attirbut :
        ----------
            url : str
        Parametres:
        ...
        if zonage1 == "france" and zonage2== "communes":
            self.url = "https://cadastre.data.gouv.fr/data/etalab-cadastre/latest/geojson/france/cadastre-france-communes.json.gz"
        else:
            self.url = "{}{}/geojson/{}/{}/{}".format(url,date,zonage1,url_zone1,fichier)
